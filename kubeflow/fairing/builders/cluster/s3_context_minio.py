from kubeflow.fairing.cloud import aws_minio
...
class S3ContextSource_minio(ContextSourceInterface):
    def __init__(self,
                 aws_account=None,
                 region=None,
                 bucket_name=None):
        ...
        return client.V1PodSpec(
            containers=[client.V1Container(name='kaniko',
                                           ...
                                           args=["--dockerfile=Dockerfile",
                                                 "--destination=" + image_name,
                                                 "--context=" + self.uploaded_context_url,
                                                 "--skip-tls-verify-registry=master000.registry"],
